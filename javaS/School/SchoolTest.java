...
public class SchoolTest {
    public static void main(String[] args) {
        ...
        double totalEarnings = student1.getFeesPaid() + student2.getFeesPaid() +
                student3.getFeesPaid() + student4.getFeesPaid() + student5.getFeesPaid();

        // Calculate total spending on teachers' salaries
        double totalSpending = mathTeacher.getSalary() + physicsTeacher.getSalary() +
                chemistryTeacher.getSalary() + literatureTeacher.getSalary();
